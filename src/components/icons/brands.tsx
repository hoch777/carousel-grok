...
/** Official Claude burst (terracotta), not a 4-point Gemini star. */
export function ClaudeMark({ className, size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function VsCodeMark({ className, size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DolphinMark({ className, size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        fill="#fff"
        d="M8 5.8h5.1c2.85 0 4.7 1.7 4.7 4.45 0 2.75-1.85 4.45-4.7 4.45H10.2V18.2H8V5.8zm2.2 6.7h2.7c1.45 0 2.4-.9 2.4-2.25S14.35 8 12.9 8H10.2v4.5z"
      />
    </svg>
  );
}

export function PlaywrightMark({ className, size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden
    >
      <circle cx="8" cy="10" r="5.2" fill="#2EAD33" />
      <circle cx="16" cy="10" r="5.2" fill="#D44B4B" />
      <circle cx="12" cy="15.2" r="5.2" fill="#2B7DE9" />
    </svg>
  );
}
